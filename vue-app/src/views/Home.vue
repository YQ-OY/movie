...
<script>
import {ListFilmScheduled, ListAllPoster, ListHots, GetFilmEvaluateAvgMap} from "@/api/film";
...
.app {
  padding: clamp(16px, 4vw, 40px) clamp(16px, 8vw, 120px);
