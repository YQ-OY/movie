      ...
      <el-table-column
        ...
        <template #default="scope">
          <el-tag v-if="scope.$index===0" type="danger" effect="plain">Top 1
            <el-icon v-for="item in 3" :key="item"><StarFilled /></el-icon>
          </el-tag>
          <el-tag v-if="scope.$index===1" type="danger" effect="plain">Top 2
            <el-icon v-for="item in 2" :key="item"><StarFilled /></el-icon>
          </el-tag>
          <el-tag v-if="scope.$index===2" type="danger" effect="plain">Top 3
            <el-icon v-for="item in 1" :key="item"><StarFilled /></el-icon>
          </el-tag>
